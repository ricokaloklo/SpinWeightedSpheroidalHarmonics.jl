...
function spin_weighted_spheroidal_harmonic(s::Int, l::Int, m::Int, c, theta, phi, theta_derivative::Int=0, phi_derivative::Int=0, N::Int=10)
    ...
    unnormalized_harmonic = _unnormalized_spin_weighted_spheroidal_harmonic(_cached_coefficients_params, _cached_coefficients, theta, phi, theta_derivative, phi_derivative)
